...
// import { Menu, X, ShoppingCart, LogIn, UserPlus, LogOut, CheckCircleIcon, LayoutDashboard } from 'lucide-react';
// import { useCart } from '@/context/CartContext';
// import { cn } from '@/lib/utils';
...
//              {/* Admin Dashboard Link - Only visible for ADMIN_USER */}
//              {userRole === 'ADMIN_USER' && (
//               <li>
//                 <Link
//                   to="/admin"
//                   className={cn(
//                     "text-sm font-medium hover:text-kitty-600 transition-colors flex items-center",
//                     isActive('/admin') 
//                       ? "text-kitty-600" 
//                       : "text-gray-700 dark:text-gray-300"
//                   )}
...
//                   to="/admin"
//                   className={cn(
//                     "block text-lg font-medium hover:text-kitty-600 transition-colors flex items-center",
//                     isActive('/admin') 
//                       ? "text-kitty-600" 
//                       : "text-gray-700 dark:text-gray-300"
//                   )}
...
import { useState, useEffect } from 'react';
import { Link, useLocation, useNavigate } from 'react-router-dom';
import { Menu, X, LogIn, UserPlus, LogOut, CheckCircle, LayoutDashboard } from 'lucide-react';
import { useCart } from '@/context/CartContext';
import { cn } from '@/lib/utils';
import {
  Dialog,
